...
describe("merged migration gap backfill", () => {
  test("applies every merged gap migration after an existing 0118 ledger tip", () => {
    ...
    // timestamp with the greatest already-recorded created_at value. The
    // shipped 0114 and 0118 ledger identities are immutable; corrective work
    // discovered afterward must be appended after the existing 0118 tip.
