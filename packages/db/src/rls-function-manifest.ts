...
export const EXPECTED_RLS_FUNCTION_DEFINITIONS: readonly RlsFunctionDefinition[] = [
  ...
  [
    ...
    "TABLE(user_id uuid, is_new boolean)",
    "plpgsql",
    "v",
    "u",
    true,
    "search_path=pg_catalog",
    "bootstrap",
    "42cdd05b16c189c429dc47b599593f7b",
    false,
    true,
  ],
  [
  ...
  [
    ...
    "search_path=pg_catalog",
    "bootstrap",
    "32738a9f1cf208e687cfb25a59e97ff7",
    false,
    true,
  ],
  [
  ...
  [
    ...
    "search_path=pg_catalog",
    "bootstrap",
    "b913161e17e3a76a26f10d68226055b1",
    false,
    true,
  ],
  [
    "steward_bootstrap.tenant_set_user_deactivation(text,uuid,uuid,boolean)",
    "TABLE(user_id uuid, deactivated_at timestamp with time zone, tokens_revoked_before bigint)",
    "plpgsql",
    "v",
    "u",
    true,
    "search_path=pg_catalog",
    "bootstrap",
    "779adf8d604810e3639865a46ee1aa70",
    true,
    false,
  ],
  [
    ...
    "search_path=pg_catalog",
    "bootstrap",
    "1015f7aa0998dea751905c61d75d6e78",
    true,
    false,
  ],
  [
    ...
    "",
    "migration",
    "d21fa9d480ee899c31a609a0599eb363",
    false,
    false,
  ],
  [
    ...
    "search_path=pg_catalog",
    "migration",
    "88032ecac08ef35e10948b9c2e6215c9",
    false,
    false,
  ],
  [
    ...
    "search_path=pg_catalog",
    "migration",
    "4b23041b4549c735955ccfb9af6c30fd",
    false,
    false,
  ],
  [
