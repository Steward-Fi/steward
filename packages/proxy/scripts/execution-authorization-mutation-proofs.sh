#!/usr/bin/env bash
# execution-authorization mutation-strength proofs (spec §11.5). Each mutation weakens ONE security
...
#
#   Run from the repo root:  bash packages/proxy/scripts/execution-authorization-mutation-proofs.sh
#
...
echo ""
echo "==================================================="
echo "execution-authorization MUTATION PROOFS: $pass_count killed, $fail_count invalid"
echo "==================================================="
