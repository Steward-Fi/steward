...
- Add `outcome_unknown` to transfer action status types so clients can reconcile an ambiguous external-custody broadcast by its deterministic transaction hash without reposting it.
