...
- Add scoped upstream credential lease issuance and revocation to `AgentClient`, with idempotency, expiry, bounded authenticated responses, redirects disabled, and the shared HTTPS-by-default base URL policy.
