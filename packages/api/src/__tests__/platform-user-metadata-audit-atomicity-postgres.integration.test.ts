...
realPostgresIt("keeps the concurrent platform metadata winner when required audit fails", async () => {
  ...
  try {
    ...
    const writer = Bun.spawn([
      ...
      env: { ...process.env, DATABASE_URL: databaseUrl!, TEST_USER_ID: userId,
