 ...
 *
 * Both `/audit/*` and evidence's `/v2/provider-actions/:id/{case,evidence}` require
 ...
 * Agent tokens are rejected. Factoring the gate here guarantees the evidence routes
