 ...
 *
 * This is the only supported write surface for join_mode. It mirrors the
 * email-config PATCH (scope gate, audit pair,
 * snapshot/restore on audit failure, update-or-insert) so operators never need
 * direct SQL for membership-mode changes.
 */
