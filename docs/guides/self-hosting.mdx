...
STEWARD_JWT_SECRET=separate-jwt-signing-key  # Required in production; minimum 32 characters
...
```bash
RPC_URL=https://sepolia.base.org             # Safe default: Base Sepolia
CHAIN_ID=84532                               # Safe default: Base Sepolia
