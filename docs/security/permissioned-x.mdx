...
status: Current implementation and limitations
date: 2026-07-16
---
...
**Status:** Current implementation and limitations. Last reviewed 2026-07-16.
...
### 6. DM / mention / hashtag / quiet-hours
...
- **DM restrictions:** the current adapter exposes NO DM operation
  ...
  the current implementation. It is documented here as a **known gap** and requires a
...
- **mention/hashtag restrictions:** expressible TODAY via
  ...
  current need without a second matcher.
...
- **Count/spend/now inputs are wired-or-deny** — the implementation proves the evaluation
