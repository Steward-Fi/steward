...
- pre-context `/auth` mutations that create or change tenant memberships still
  need fixed-shape bootstrap functions or post-verification tenant transactions;
