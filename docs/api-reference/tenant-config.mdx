...
The ACS route is intentionally disabled until signed assertion validation, audience/recipient checks, expiry enforcement, verified-domain enforcement, and replay protection are implemented with SAML fixtures. It returns `501` instead of accepting assertions.
