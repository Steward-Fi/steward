        ...
        <div className="space-y-3">
          {pending.map((item, i) => (
            <motion.div
              ...
              className="border border-border p-6 bg-bg-elevated hover:bg-bg-surface transition-colors"
            >
              <div className="flex items-start justify-between gap-6">
                  ...
                  {item.transaction?.policyResults &&
                    item.transaction.policyResults.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mt-1">
                        {item.transaction.policyResults.map(
                          (result, ri) => (
                            <span
                              key={ri}
                ...
                <div className="flex gap-2 flex-shrink-0">
                  <button
                    ...
                    className="px-4 py-2 text-xs font-medium bg-emerald-400/10 text-emerald-400 hover:bg-emerald-400/20 transition-colors disabled:opacity-40"
                  >
                  ...
                  <button
                    ...
                    disabled={actionLoading !== null}
                    className="px-4 py-2 text-xs font-medium bg-red-400/10 text-red-400 hover:bg-red-400/20 transition-colors disabled:opacity-40"
                  >
