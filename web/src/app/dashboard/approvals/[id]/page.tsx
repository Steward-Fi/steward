...
/**
 * Provider-action approval-detail surface (U4).
 *
 * Consumes the approval-lifecycle GET/POST /v2/provider-actions/:id/approval routes (NOT the
 ...
 *     digests. NEVER canonical bytes or comment body text (approval-lifecycle §5.3).
...
export default function ProviderApprovalDetailPage() {
  ...
  async function decide(decision: "approve" | "deny") {
    // Client-side reason gate (the server ALSO enforces this, U4/approval-lifecycle §9.2).
