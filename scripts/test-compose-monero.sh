...
export STEWARD_DB_PLATFORM_PASSWORD=compose-contract-platform-password
export STEWARD_BOOTSTRAP_SET_ROLE_PASSWORDS=true
export STEWARD_ADMIN_DATABASE_URL=postgres://steward:steward_ci@postgres:5432/steward_test
export MIGRATION_DATABASE_URL=postgres://steward_migrator:compose-contract-migration-password@postgres:5432/steward_test
export DATABASE_URL=postgres://steward_app:compose-contract-app-password@postgres:5432/steward_test
export STEWARD_PLATFORM_DATABASE_URL=postgres://steward_platform:compose-contract-platform-password@postgres:5432/steward_test
export STEWARD_APP_DATABASE_ROLE=steward_app
export STEWARD_BOOTSTRAP_DATABASE_ROLE=steward_bootstrap_owner
export STEWARD_MIGRATION_DATABASE_ROLE=steward_migrator
export STEWARD_PLATFORM_DATABASE_ROLE=steward_platform
